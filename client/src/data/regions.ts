...
export const REGIONS: Region[] = [
  {
    ...
    ports: [
      ...
      { name: "San Francisco",     lat: 37.8044, lon: -122.4079, sublabel: "California" },
      { name: "Santo Domingo",     lat: 18.4861, lon: -69.9312 },
      { name: "Savannah",          lat: 32.0835, lon: -81.0998, sublabel: "Georgia" },
      { name: "Tampa Bay",         lat: 27.94,   lon: -82.45,   sublabel: "Florida" },
    ],
  },
  {
