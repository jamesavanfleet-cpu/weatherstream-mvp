...
export const REGIONS: Region[] = [
  ...
  },
  {
    ...
    ports: [
      { name: "Belize City",       lat: 17.25, lon: -88.77, marineLat: 17.25, marineLon: -87.80 },
  ...
  },
  {
    ...
    ports: [
      ...
      { name: "Corsica",           lat: 42.04, lon:  9.01, marineLat: 42.00, marineLon:  8.90 },
      ...
      { name: "Sardinia",          lat: 39.22, lon:  9.12, marineLat: 39.00, marineLon:  8.80 },
