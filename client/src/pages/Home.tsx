...
// Temporary public visibility setting. Preserve the video configuration and modal for quick restoration.
const SHOW_VIDEO_BRIEFING = false;
...
const LIVE_DATA = [
  ...
  { location: "Grenada", sublabel: null, lat: 12.11, lon: -61.68, temp: 83, condition: "Sunny", icon: ThermometerSun, color: "from-orange-400 to-amber-400" },
  ...
  { location: "Jacksonville", sublabel: "Florida", lat: 30.3322, lon: -81.6557, temp: 72, condition: "Partly Cloudy", icon: Cloud, color: "from-sky-400 to-blue-500" },
  { location: "Juneau", sublabel: "Alaska", lat: 58.30, lon: -134.42, temp: 48, condition: "Partly Cloudy", icon: Cloud, color: "from-slate-500 to-blue-500" },
  { location: "Ketchikan", sublabel: "Alaska", lat: 55.34, lon: -131.65, temp: 50, condition: "Partly Cloudy", icon: Cloud, color: "from-slate-400 to-cyan-500" },
  ...
  { location: "Samaná", sublabel: null, lat: 19.21, lon: -69.34, temp: 81, condition: "Partly Cloudy", icon: Cloud, color: "from-teal-400 to-blue-400" },
  ...
  { location: "Seattle", sublabel: "Washington", lat: 47.61, lon: -122.33, temp: 52, condition: "Partly Cloudy", icon: Cloud, color: "from-slate-500 to-teal-500" },
  { location: "Sitka", sublabel: "Alaska", lat: 57.05, lon: -135.33, temp: 46, condition: "Partly Cloudy", icon: Cloud, color: "from-slate-400 to-blue-400" },
  { location: "Skagway", sublabel: "Alaska", lat: 59.46, lon: -135.31, temp: 44, condition: "Partly Cloudy", icon: Cloud, color: "from-slate-500 to-indigo-500" },
  ...
  { location: "St. Vincent", sublabel: null, lat: 13.16, lon: -61.22, temp: 82, condition: "Partly Cloudy", icon: Cloud, color: "from-teal-500 to-cyan-500" },
  { location: "Tampa Bay", sublabel: "Florida", lat: 27.9333, lon: -82.4500, temp: 76, condition: "Partly Cloudy", icon: Cloud, color: "from-sky-500 to-cyan-500" },
  { location: "Tracy Arm Fjord",sublabel: "Alaska", lat: 57.85, lon: -133.65, temp: 45, condition: "Partly Cloudy", icon: Cloud, color: "from-slate-600 to-cyan-600" },
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen gradient-animate overflow-x-hidden">
        ...
        <div className="container relative z-10 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-6 lg:py-0">
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap gap-3">
              ...
              <Button
                size="lg"
                className="hidden md:flex md:w-auto bg-gradient-to-r from-amber-500 to-amber-600 hover:opacity-90 text-gray-900 border-0 shadow-lg"
      ...
      {SHOW_VIDEO_BRIEFING && briefingVideoOpen && (
        <div
