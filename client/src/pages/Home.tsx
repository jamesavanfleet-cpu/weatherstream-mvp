...
const LIVE_DATA = [
  ...
  { location: "Havana", lat: 23.1367, lon: -82.3589, color: "#22d3ee", icon: "🌴" },
  ...
  { location: "Jacksonville", lat: 30.3322, lon: -81.6557, color: "#22d3ee", icon: "⚓" },
  ...
  { location: "Port Canaveral", lat: 28.4083, lon: -80.6167, color: "#22d3ee", icon: "⚓" },
  { location: "Port Everglades", lat: 26.0833, lon: -80.1167, color: "#22d3ee", icon: "⚓", sublabel: "Fort Lauderdale" },
  ...
  { location: "Tampa Bay", lat: 27.9333, lon: -82.4500, color: "#22d3ee", icon: "⚓" },
